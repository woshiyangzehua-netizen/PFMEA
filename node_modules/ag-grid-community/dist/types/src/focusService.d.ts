...
import type { TabToNextGridContainerTarget, TabToNextHeaderParams } from './interfaces/iCallbackParams';
...
export declare class FocusService extends BeanStub implements NamedBean {
    ...
    private getGridBodyTabTarget;
    private getGridViewTabTarget;
