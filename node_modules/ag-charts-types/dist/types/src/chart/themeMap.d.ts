...
type ThemesMap<TDatum = DatumDefault, TContext = ContextDefault> = AgChartThemeOverrides<TDatum, TContext> & {
    'linear-gauge'?: {
        series: AgLinearGaugeOptions<TDatum, TContext>;
    };
    'radial-gauge'?: {
        series: AgRadialGaugeOptions<TDatum, TContext>;
    };
};
export type ExtensibleTheme<SType extends SeriesType, TDatum = DatumDefault, TContext = ContextDefault> = WithThemeParams<NonNullable<ThemesMap<TDatum, TContext>[SType]>>;
export {};
