...
export interface AgLineSeriesStylerParams<TDatum, TContext> extends AgLineSeriesOptionsKeys<TDatum>, SeriesCallbackParams<HighlightState>, ContextCallbackParams<TContext>, Required<StrokeOptions>, Required<LineDashOptions> {
