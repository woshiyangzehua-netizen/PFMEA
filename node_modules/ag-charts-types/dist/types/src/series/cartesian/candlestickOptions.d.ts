...
import type { AgBaseCartesianSeriesAxisOptions, AxisOptions, FillOptions, LineDashOptions, StrokeOptions } from './commonOptions';
...
export interface AgCandlestickSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends AgCandlestickSeriesThemeableOptions<TDatum, TContext>, Omit<AgBaseSeriesOptions<TDatum, TContext>, 'highlight'>, AgBaseCartesianSeriesAxisOptions, AgOhlcSeriesBaseOptions<TDatum>, Omit<AxisOptions<TDatum>, 'yKey'> {
